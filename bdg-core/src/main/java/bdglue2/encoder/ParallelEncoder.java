/* ./src/main/java/bdglue2/encoder/ParallelEncoder.java
 *
 *
...
import bdglue2.publisher.ParallelPublisher;

import bdglue2.source.gghadoop.GG12Handler;
...
public class ParallelEncoder extends Thread {
    ...
    public static void forceShutdown(String msg) {
        /*
         * TODO: need to find a way to do this not tied to GG12Handler.
         */
